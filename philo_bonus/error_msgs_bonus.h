...
/*   Updated: 2024/03/27 16:03:08 by hmrabet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define EACCESS_ERR1 "The required permissions (for reading and/or writing) ar"
# define EACCESS_ERR2 "e denied for the given flags; or O_CREAT is specified, "
# define EACCESS_ERR3 "the object does not exist, and permission to create "
# define EACCESS_ERR4 "the semaphore is denied.\n"
# define EEXIST_ERR "O_CREAT & O_EXCL specified and the semaphore exists.\n"
...
# define ENFILE_ERR "Too many semaphores or fds are open on the system.\n"
# define ENOENT_ERR "O_CREAT is not set and the named sema does not exist.\n"
# define ENOSPC_ERR1 "O_CREAT is specified, the file does not exist, and there "
# define ENOSPC_ERR2 "is insufficient space available to create the sema.\n"
